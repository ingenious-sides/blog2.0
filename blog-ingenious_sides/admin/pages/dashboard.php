...
if(hasnt_password() == 1){ /*si on n'a pas de mdp on est redirigé vers la page password sans menu*/
...
<div class="row">
    ...
    <?php
            /* je créé un tableau qui concernera les différentes tables que je veux analyser */
        $tables = [
            "Publications"      =>  "posts",
                ...
                <div class="col l4 m6 s12">
                    <div class="card">
                        <div class="card-content <?= getColor($table,$colors) ?> white-text">
                            ...
                            <h4><?= $nbrInTable[0] ?></h4> <!-- nbrInTable = nombre ds la table et comme c'est ds un tableau on reprend l'index 0-->
                        </div>
                    </div>
                </div>
            <?php
...
<!-- ici on affiche la session de connexion admin au dashboard -->
<!--<pre>
    <?php
